...
#pragma warning disable 649
    ...
    [SerializeField] private GameObject gameOverPanel, gameEndPanel,pausePanel, mainMenu, gamePanel, questionInfo, optionsHolder, topHolder;
...
#pragma warning restore 649
    ...
    public GameObject GameEndPanel { get => gameEndPanel; }                     //getter

      public GameObject PausePanel { get => pausePanel; }                     //getter
    public GameObject QuestionInfo { get => questionInfo; }                     //getter
    public GameObject OptionsHolder { get => optionsHolder; }                     //getter
    public GameObject TopHolder { get => topHolder; }                     //getter
    ...
    {   
        ...
        for (int i = 0; i < quizManager.QuizData.Count; i++)
        {
            ...
            if(quizManager.QuizData[i].categoryName=="Cyber Security"){
